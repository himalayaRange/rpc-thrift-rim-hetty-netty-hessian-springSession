...
import com.github.wangyi.thrift.simpleRpc.appchina_rpc.base.cluster.LoadBalance;
import com.github.wangyi.thrift.simpleRpc.appchina_rpc.base.cluster.RoundrobinLoadBalance;
    ...
    */
	...
	protected Config getPoolConfig() {
	  	GenericObjectPool.Config config = new GenericObjectPool.Config();
	   	...
	   	//lifo后进先出，默认情况下是true,设为false保证全部轮询
	   	config.lifo = false;
	   	return config;
	}
